"""
Django settings for hg_proj project.
...
SECRET_KEY = 'hlq)4(ey=1+ah!@mb*(n(dg*!@wudxzz$16#!w8u1q=nt(+xdy'
...
WSGI_APPLICATION = 'hg_proj.wsgi.application'
